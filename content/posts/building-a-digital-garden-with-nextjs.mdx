...
The degree of a node tells you how "hub-like" a concept is. For a graph $G$ with $n$ nodes, a node's degree centrality is:
...
$$\text{readingTime} = \left\lceil \frac{wordCount}{200} \right\rceil \text{ min}$$
